...
var Mock, SOCKET_INSTANCE_ALIASES, SOCKET_INSTANCE_OPTIONS_KEYS, SOCKET_INSTANCE_PROPERTIES_PRIVATE, SOCKET_INSTANCE_PROPERTIES_PUBLIC, connect, connectApp, express, expressApp, request, sendTestMessage, sselib, testMessage, testMiddleware;
...
testMiddleware = function(connectApp, expressApp) {
  return describe("As middleware", function() {
    ...
    return describe('middleware API', function() {
      ...
      SOCKET_INSTANCE_PROPERTIES_PUBLIC.forEach(function(property) {
        return it("should provide the public property " + property + " under res.sse", function(done) {
          return app(mock.req, mock.res, function() {
      ...
      SOCKET_INSTANCE_PROPERTIES_PRIVATE.forEach(function(property) {
        return it("should provide the private property " + property + " under res.sse", function(done) {
          return app(mock.req, mock.res, function() {
            mock.res.sse.should.have.property(property);
            return done();
          });
      ...
      return SOCKET_INSTANCE_ALIASES.forEach(function(property) {
        return it("should provide the alias " + property + " under res.sse", function(done) {
          return app(mock.req, mock.res, function() {
            mock.res.sse.should.have.property(property);
            return done();
          });
